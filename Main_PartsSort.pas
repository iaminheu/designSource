...
begin
  inherited;
  TB_App.Visible:= mdlData.PermissionCheckRights(TFrm_PartsSort.ClassName,'新增');
//  TB_Edit.Visible:= mdlData.CheckFrmRights(TFrm_PartsSort.ClassName,'修改');
//  TB_Del.Visible:= mdlData.CheckFrmRights(TFrm_PartsSort.ClassName,'删除');
  TB_Prin.Visible:= mdlData.PermissionCheckRights(TFrm_PartsSort.ClassName,'打印');
