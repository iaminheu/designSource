...
begin
  inherited;
  If DataSet['FApprovalQry']=Null then
     DataSet['FApprovalQry']:=0;
  If DataSet['FPrice']=Null then
     DataSet['FPrice']:=0;
  DataSet['FTotalAmount']:=round(DataSet['FApprovalQry']*DataSet['FPrice']*100)/100;
end;
     ...
     //循环行开始
      ...
      Begin
        ...
        Begin
          ...
          MyWorkBook.WorkSheets[k].Cells[i,7].Value := mdata_List.FieldByName('FApprovalQry').AsString;
