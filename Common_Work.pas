...
var
    ...
    ListItemFNumber,ListItemFNumber1,ListItemFNumber2,ListItemFNumber3,ListItemFNumber4:String;  //树代码
...
begin
  ...
  Try
    ...
    qry.close;
    qry.SQL.Text:='Select distinct FNumber, FParentNumber, FNumber, FName from  '+MyDS
                 +' Where FParentNumber='''' order by FNumber';
    qry.Open;
...
begin
  ...
  Try
    ...
    qry.SQL.Text:='Select FNumber, FParentNumber, FNumber, FName from  '+MyDS
                 +' Where FParentNumber='''' and FDepartmentID'+Mywhere+IntToStr(MyID)+' order by FNumber';
    qry.Open;
    while not Qry.Eof do
    begin
      New(P);
...
begin
  ...
  Try
    ...
    qry.close;
    qry.SQL.Text:='Select FNumber, FParentNumber, FNumber, FName from  '+MyDS
                 +' Where FParentNumber='''' and FDepartmentNumber like '''+likeNum+'%'' order by FNumber';
    qry.Open;
    while not Qry.Eof do
    begin
      New(P);
...
begin
  ...
  Try
    ...
    qry.close;
    qry.SQL.Text:='Select FNumber, FParentNumber, FNumber, FName from  '+MyDS
                 +' Where FParentNumber='''' and FDepartmentID='+IntToStr(likeID)+' order by FNumber';
    qry.Open;
    while not Qry.Eof do
    begin
      New(P);
...
begin
  ...
  Try
    ...
    qry.close;
    qry.SQL.Text:='Select FNumber, FParentNumber, FNumber, FName from  '+MyDS
                 +' Where (FParentNumber='''' or FNumber like ''%'+likeNum+'%'') and (FDepartmentID='+IntToStr(likeID)+') order by FNumber';
    qry.Open;
    while not Qry.Eof do
    begin
      New(P);
...
begin
  ...
  Try
    If OrderName='' then
      //qry.SQL.Text:='Select IsEdit=cast(0 as bit),* from '+MyDS+' Where '+LikeFNumber+' like '''+ListItemFNumber+'%'''
      qry.SQL.Text:='Select IsEdit=cast(0 as bit),* from '+MyDS+' Where substring('+LikeFNumber+',1,len('''+ListItemFNumber+'''))='''+ListItemFNumber+''''

    else
     // qry.SQL.Text:='Select IsEdit=cast(0 as bit),* from '+MyDS+' Where '+LikeFNumber+' like '''+ListItemFNumber+'%'' order by '+OrderName;
      qry.SQL.Text:='Select IsEdit=cast(0 as bit),* from '+MyDS+' Where substring('+LikeFNumber+',1,len('''+ListItemFNumber+'''))='''+ListItemFNumber+''' order by '+OrderName;
    qry.Open;
